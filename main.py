...
from export_data import export_all_powerbi_data
...
def main():
    ...
    print("\n" + "=" * 70)
    print("STEP 5: POWER BI DATA EXPORT")
    print("=" * 70)
    try:
        processed_data, predictions, segments = export_all_powerbi_data(df, predictor, segmentation)
        print("✅ Power BI data export completed successfully!")
    except Exception as e:
        print(f"❌ Error in Power BI export: {e}")
        sys.exit(1)
    
    # Print footer
    print_footer()
    
    # Save processed dataframe for Streamlit app (legacy support)
    print("\n💾 Saving processed data for Streamlit dashboard...")
    df.to_csv('data/processed_data_legacy.csv', index=False)
    print("✓ Data saved to 'data/processed_data_legacy.csv'")
    ...
    print("   2. 📁 Import CSV files from 'data/' folder:")
    ...
    print("   4. 📈 Build dashboard using provided design")
    print("   5. 🎨 Or view interactive dashboard: streamlit run app.py")
